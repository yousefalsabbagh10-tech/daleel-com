  ...
  return (
    <div className="bg-white p-6 rounded-3xl border border-gray-150 space-y-4 text-right animate-fadeIn" dir="rtl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1 text-right">
          <label className="text-xs font-bold text-gray-600">رقم الاتصال</label>
          <input
            type="tel"
            value={ownerPhone}
            onChange={(e) => setOwnerPhone(e.target.value)}
            className="w-full h-11 px-4 bg-slate-50 border border-gray-200 rounded-xl text-xs font-extrabold font-mono text-right outline-none"
            placeholder="09xxxxxxxx"
          />
        </div>
        <div className="space-y-1 text-right">
          <label className="text-xs font-bold text-gray-600">رقم واتساب</label>
          <input
            type="tel"
            value={whatsappPhone}
