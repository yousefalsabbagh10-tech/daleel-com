...
export function HomeSidebarWidgets() {
  ...
  return (
    <div className="w-full lg:w-1/3 flex flex-col gap-4 lg:pt-[38px]" dir="rtl">
      <div className="apple-card h-32 bg-[#2B2B2B] relative overflow-hidden group cursor-pointer">
        <img
        ...
        <div className="absolute bottom-4 right-4 left-4 text-white z-10 text-right">
          ...
          <p className="text-xs text-[#F6F2E8] line-clamp-1">اكتشف أحدث العقارات</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className="apple-card p-4 flex flex-col items-center justify-center gap-2 hover:bg-[#F6F2E8] transition-colors text-[var(--color-primary)] h-24 cursor-pointer"
        >
          ...
          <span className="text-[13px] font-bold text-[#2B2B2B]">الإعلانات المميزة</span>
        </button>
        ...
        >
          ...
          <span className="text-[13px] font-bold text-[#2B2B2B]">أضف إعلانك</span>
        </button>
      </div>
