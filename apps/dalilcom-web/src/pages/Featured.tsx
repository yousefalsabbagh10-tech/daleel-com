...
export function FeaturedPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-gradient-to-r from-[var(--color-primary)] to-[#C9A15A] rounded-3xl p-8 text-white shadow-lg overflow-hidden relative">
        <div className="relative z-10 flex flex-col items-start gap-4">
          <div className="bg-white/20 p-3 rounded-2xl backdrop-blur-sm">
            <Star size={32} className="fill-white" />
          </div>
          <h2 className="text-3xl font-bold">المنتجات المميزة</h2>
          <p className="text-[#F6F2E8]/85 max-w-lg leading-relaxed">
        ...
        <div className="absolute bottom-0 right-10 w-40 h-40 bg-[#0D3B46]/20 rounded-full blur-2xl translate-y-1/2"></div>
      </div>
