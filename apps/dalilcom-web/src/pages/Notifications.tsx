...
export function NotificationsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 px-1 py-4 pb-24 relative select-none" dir="rtl">
      {toast && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-xs font-bold px-5 py-3 rounded-2xl shadow-xl z-50">
          {toast}
        </div>
      )}
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-black text-slate-900">مركز الإشعارات</h2>
      ...
      <div className="space-y-3.5">
            ...
            <div className="flex gap-3 sm:gap-4 items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline gap-2 mb-1.5">
                  <h3 className="font-extrabold text-xs sm:text-sm leading-snug text-slate-900">{item.title}</h3>
        ...
        {notifications.length === 0 && (
          <div className="py-20 text-center text-slate-400 bg-white rounded-3xl border border-dashed border-gray-200">
            صندوق الوارد فارغ
          </div>
        )}
      </div>
