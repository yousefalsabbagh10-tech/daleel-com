...
export function LoginSuccessView({ phone, onCreateAd, onLogout }: LoginSuccessViewProps) {
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-8 rounded-3xl shadow-sm border border-[#F6F2E8] text-center animate-in fade-in zoom-in-95 duration-500" dir="rtl">
      ...
      <p className="text-[#C9A15A] mb-8 text-[15px]">
        أنت مسجل الدخول بالرقم: <span className="font-semibold text-[#2B2B2B]" dir="ltr">{phone}</span>
      </p>
      <button
        onClick={onCreateAd}
