    ...
    <div className="fixed inset-0 z-50 overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-y-0 left-0 right-0 md:left-auto md:right-0 w-full md:max-w-md bg-white shadow-2xl flex flex-col h-full overflow-hidden">
          ...
          {activeSubPanel ? (
            ...
            <div className="space-y-5 animate-in fade-in duration-200">
              ...
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-gray-700 block">التصنيف الرئيسي للبحث</label>
                    ...
                    <button
                      ...
                      className={`py-2 text-xs font-bold rounded-lg transition-all cursor-pointer ${
                        filters.category === cat.id 
                          ? `bg-white ${cat.color || 'text-gray-900'} shadow-sm font-extrabold` 
              ...
              <div className="space-y-1.5">
                <label className="text-[13px] font-bold text-gray-700 block">البحث بكلمة دلالية</label>
              ...
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-gray-700 block">نطاق السعر المقبول (ل.س)</label>
              ...
              <div className="space-y-1.5">
                <label className="text-[13px] font-bold text-gray-700 block">المنطقة والموقع</label>
                <button
                  type="button"
        ...
        <div className="p-4 bg-white border-t border-gray-100 flex items-center gap-3 shrink-0">
          ...
          <button 
            onClick={() => setIsFilterPanelOpen(false)}
            className="px-5 py-3 border border-gray-250 hover:bg-gray-50 text-gray-550 rounded-xl text-center font-bold text-xs cursor-pointer"
          >
            إلغاء
          </button>
        </div>
