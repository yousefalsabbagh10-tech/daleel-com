...
const styles = StyleSheet.create({
  ...
  filterBtn: { backgroundColor: '#1e3c5a', borderRadius: BORDER_RADIUS.full, paddingHorizontal: SPACING.md, height: 40, flexDirection: 'row-reverse', alignItems: 'center', gap: SPACING.xs },
  ...
  resetBtn: { marginTop: SPACING.lg, backgroundColor: '#eef5ff', paddingVertical: SPACING.sm, paddingHorizontal: SPACING.lg, borderRadius: BORDER_RADIUS.full },
  resetText: { color: '#1e3c5a', fontWeight: '900' },
});
