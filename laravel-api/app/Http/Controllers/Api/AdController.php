...
{
    private array $adFields = ['id','owner_user_id','category','title','description','price','currency','location','subcategory','purpose','cover_image_url','is_featured','published_on'];
